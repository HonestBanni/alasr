                           ...
                           <?php echo form_open('',array('class'=>'course-finder-form'));
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <?php
                                            echo form_dropdown('company', $company,$companyid,  'class="form-control" id="company_id"');
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <?php
                                            echo form_dropdown('products', $products,$productid,  'class="form-control" id="products_id"');
                          ...
                          <tbody>
                              <?php
                                 ...
                                 $total = $row->pur_price*$row->quantity;
                                  ...
                                  echo '<td>'.$sn.'</td>';
                                  echo '<td>'.date('d-M-Y',  strtotime($row->stock_date)).'</td>';
                                  ...
                                  echo '<td>'.$total.'</td>';
                                  echo ' </tr>';
                                  $gtotal +=$row->pur_price*$row->quantity;
...
<!--             Query time: {elapsed_time}-->
 ...
 $( function() {
   ...
   jQuery(document).ready(function(){
       ...
       jQuery("#company_id").on("click",function(){
