...
<head>
    ...
    <!--<link rel="stylesheet" href="assets/App/plugins/pretty-photo/css/prettyPhoto.css">-->
      <link href="assets/App/css/jquery-ui.css" rel="Stylesheet"></link
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="assets/App/css/styles.css">
       <script type="text/javascript" src="assets/App/plugins/jquery-1.12.3.min.js"></script>
</head>
