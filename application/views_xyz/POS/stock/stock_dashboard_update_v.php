                        ...
                        <div class="section-content" >
                                <div class="row">
                                     <div class="col-md-4 col-sm-5">
                                        ...
                                        <?php
                                            echo form_dropdown('companyname', $companies,$stock_invoice->pro_company_id,  'class="form-control" id="companyname"');
                                        ?>
                                        <input type="hidden" name="formCode" id="formCode" value="<?php   echo $formCode;?>">   
                                     <input type="hidden" name="stock_id" id="stock_id" value="<?php   echo $this->uri->segment(2);?>">   
                                    </div>    
                                     <div class="col-md-2">
                                     ...
                                     <div class="col-md-4 col-sm-5">
                                        ...
                                        <?php
                                            echo form_input(array(
                                                    ...
                                                    'type'          => 'text',
                                                    'value'         => date('d-m-Y',strtotime($stock_invoice->stock_date)),
                          ...
                          <div style="padding-top:1%;">
                                <div class="col-md-4 pull-right">
                                     ...
                                     <button type="button" class="btn btn-theme" name="updateProducts" id="updateProducts"> <i class="fa fa-book"></i> Save</button>
                                     <button type="button" class="btn btn-theme " name="deleteInvoice" id="deleteInvoice">   <i class="fa fa-trash "></i> Delete Invoice</button>
                               </div>
                            </div>
...
//                dataType: 'json',
   ...
   jQuery("#updateProducts").on('click',function(){
      ...
      jQuery.ajax({
                ...
                data : {'stock_id':stock_id,'companyname':companyname,'currentAmount':currentAmount,'orderDate':orderDate,'payableAmount':payableAmount,'formCode':formCode},
                success:function(data){
                   
                    alert('Stock Update Successfully');
                    window.location.href = "StockUpdate";
                }
                    });      
       ...
       jQuery('#deleteInvoice').on('click',function(){
       var stock_id         = jQuery('#stock_id').val(); 
       
   if(confirm('Are you sure to delete this invoice?')){
        jQuery.ajax({
             type:'post',
                url : 'deleteStockInvoice',
