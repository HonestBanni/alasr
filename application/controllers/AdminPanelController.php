...
//            $where                      = array('user_company_id'=>$this->userInfo->company_id);
    ...
    public function admin_home_events(){
     ...
     if($this->input->post('addAdminEvents')):
     ...
     if($this->input->post('updateEvents')):
...
//            echo '<pre>';print_r($this->input->post());die;
            ...
            $this->CRUDModel->update('site_events',$data,array('id'=>$event_id));
            
            $slug =  $this->CRUDModel->slugify($title);
               $sluge_check =   $this->db->get_where('site_events',array('event_slug'=>$slug,'id !='=>$event_id))->row();
               $post_slug = ''; 
               if(empty($sluge_check)):
                  $post_slug = $slug;  
                    else:
                ...
                $this->CRUDModel->update('site_events',array('event_slug'=>$post_slug),array('id'=>$event_id));
            
             redirect('AdminEvents');
     endif;
     endif;
     if($this->input->post('deleteEvents')):
         $id = $this->input->post('event_id');
         $this->CRUDModel->deleteid('site_events',array('id'=>$id));
         redirect('AdminEvents');
     endif;    
...
//            echo '<pre>';print_r($gallery);die;
               if(!empty($gallery)):  
                    ...
                    foreach($gallery as $Row):
                                ...
                                echo '<div class="col-md-3 col-12 text-center">
                                    <div class="album-cover"  style="min-height: 0px !important;">
                                        <a href="javascript:void(0)" id="'.$Row->id.'"  class="updateEvents"  data-toggle="modal" data-target="#updateEventsModel"><img class="img-fluid" style="height: 140px;width: 259px;" src="SiteAssets/images/events/'.$Row->image.'" alt="'.$Row->title.'"></a>
                                        <div class="desc" style="padding: 1px !important;">
                                            <h4><small><a  href="javascript:void(0)"  id="'.$Row->id.'" class="updateEvents"  data-toggle="modal" data-target="#updateEventsModel" ><strong>'.$Row->title.'</strong></a></small></h4>
                                            <h4><small>'.$Row->description.'</small></h4>
                  ...
                  ?>
                    ...
                    jQuery(document).ready(function(){
                            ...
                            jQuery('.deleteNav').on('click',function(){
                             ...
                             jQuery('.updateEvents').on('click',function(){
                             var Events_id = this.id;
                             ...
                             jQuery.ajax({
                                ...
                                success:function(result){
                                    ...
                                    jQuery('#show_updateEvents').html(result);
    ...
    public function admin_events_update_js(){
          
            $Events_id          = $this->input->post('Events_id'); 
          $site_news        = $this->db->get_where('site_events',array('id'=>$Events_id))->row();
          $status          = $this->CRUDModel->dropDown('site_status', 'Select Status', 'id', 'title',array('status'=>1));
         ...
         if($site_news):
            ...
            <div class="modal-body">
                 <div class="row">
                  <div class="col-md-12">
                          ...
                          <div class="col-md-4 col-sm-5">
                              <label for="name">Title</label>
                              <input type="text" name="title" value="'.$site_news->title.'" id="title" class="form-control" placeholder="Event Title">
                          </div>
                          <div class="col-md-4 col-sm-5">
                              <label for="name">Event Date</label>
                              <input type="text" name="event_date" value="'.date('d-m-Y',strtotime($site_news->create_datetime)).'" id="event_date" class="form-control datepicker">
                          </div>
                          <div class="col-md-4 col-sm-5">
                              <label for="name">Total Days</label>
                              <input type="text" name="total_days" value="'.$site_news->event_days.'"  id="total_days" class="form-control">
                          </div>
                          <div class="col-md-4 col-sm-5">
                              <label for="name">Place</label>
                              <input type="text" name="place" value="'.$site_news->place.'"  id="place" class="form-control">
                          </div>
                          <div class="col-md-4 col-sm-5">
                              <label for="name">School</label>
                              <input type="text" name="school" value="'.$site_news->school_name.'"  id="school" class="form-control">
                          </div>
                          <div class="col-md-4 col-sm-5">
                              <label for="name">Time</label>
                              <input type="time" name="time" value="'.$site_news->date_time.'"   class="form-control">
                          </div>
                          ...
                          <div class="col-md-8 col-sm-5">
                              ...
                              <input type="hidden" name="event_id" value="'.$site_news->id.'" id="banenr_id" class="form-control">
                              <input type="hidden" name="old_image" value="'.$site_news->image.'" id="old_image" class="form-control">
                          ...
                          <div class="col-md-12 col-sm-5">
                              <br/>
                               ...
                               <label for="name">News Image</label>
                                <br/>
                              <img height="" src="SiteAssets/images/events/'.$site_news->image.'" style="border-radius: 20px;height: 100px;width: 250px;">
                              <input type="file" name="file"   id="file" class="form-control" placeholder="Select Image ">
            ...
            <div class="modal-footer">
                  <button type="submit" name="updateEvents"     value="updateEvents"  class="btn btn-theme"> <i class="fa fa-plus"></i> Update</button>
                  <button type="submit" name="deleteEvents"     value="deleteEvents"  class="btn btn-danger"> <i class="fa fa-trash"></i> Delete</button>
                  <button type="button" class="btn btn-theme" data-dismiss="modal">Close</button>
