           ...
           <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="col-md-3 col-sm-5">
                        ...
                        <input type="text" name="title" value="'.$site_news->title.'" id="uname" class="form-control" placeholder="Company Name  ">
                    </div>
                    <div class="col-md-3 col-sm-5">
                        <label for="name">Place</label>
                        <input type="text" name="t_dayes" value="'.$site_news->place.'" id="t_dayes" class="form-control" placeholder="Total Days">
                    </div>
